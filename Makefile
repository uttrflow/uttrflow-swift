...
.PHONY: verify
verify: pii-audit disclosure-audit docs-audit comment-audit match-audit lint build coverage offline-audit ## The whole gate: PII, disclosure, docs, comments, word matches, lint, build, tests, coverage floor, offline audit.
