...
SCENARIOS=(
  ...
  "term-git-s-accept|term|t:25:git s; eg:3; k:124; p:700; ex:ACCEPT text=git s.* via=:2; rb:line: git s[a-z-]+( .*)?$"
  "term-typed-past-3x-goes-quiet|term|t:25:git c; el:3; t:25:x; p:400; k:51; el:3; t:25:z; p:400; k:51; el:3; t:25:q; ex:QUIET typed=git cq .*rejections=3:3"
