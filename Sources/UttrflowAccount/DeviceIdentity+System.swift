...
extension MacDeviceIdentity {
    ...
    /// Settings — "User's MacBook Pro" — which is exactly the string that makes a device
    ...
    /// stands in; a device called `Users-MacBook-Pro.local` is still recognisable, and a
