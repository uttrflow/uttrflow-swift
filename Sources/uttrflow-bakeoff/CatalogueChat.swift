    ...
    static let chat: [Scenario] = [
        chat(
            ...
            thread: """
                ...
                """,
            own: ["in dist/, one sec", "on my way", "running late, sorry", "yes!", "save me a seat", "be there in 10"],
            lines: [
        ...
        chat(
            ...
            thread: """
                ...
                """,
            own: ["haan bilkul", "theek hai", "kal milte hain", "abhi busy hoon", "chalo done", "5 min mein aata hoon"],
            lines: [
                "haan chalo", Line("theek hai bhai", determinacy: .prose), Line("kal milte hain", determinacy: .prose),
                "abhi busy hoon, baad mein call karta hoon", "kitne baje milna hai", "mujhe thoda late hoga",
                "khana wahi kha lenge", "ticket book kar diya", Line("main nikal raha hoon", determinacy: .prose),
        ...
        chat(
            ...
            thread: """
                ...
                """,
            own: [
                "love you too", "will call in the evening", "thank you so much!", "yes had lunch", "reached safely",
                "talk tonight",
            ],
            lines: [
                ...
                "reached safely, don't worry", "talk tonight after work", "miss you both", "send me the recipe",
        ...
        chat(
            ...
            thread: """
                ...
                """,
            own: [
                "Confirmed, thanks.", "Works for me.", "I will send the numbers after lunch.", "Taking a look now.",
            ...
            lines: [
                ...
                "Standup notes are in the thread.", "I am out tomorrow afternoon.", "Let me check with the infra team.",
            ]),
        chat(
            ...
            thread: """
                ...
                """,
            own: ["haha yes", "count me in", "bro that was wild", "same 😂", "let's gooo 🔥", "bring the snacks"],
            lines: [
                Line("count me in", determinacy: .prose), "haha yes 😂", Line("bro that was wild", determinacy: .prose),
                "same bro 😂", "let's gooo 🔥", "bring the snacks 🍕", "what time saturday", "i'll get the drinks",
        ...
        chat(
            ...
            thread: """
                ...
                or a replacement?
                """,
            own: ["it's order 4471", "my order hasn't arrived", "a replacement please", "can I talk to a human"],
            lines: [
                Line("a replacement please", determinacy: .prose), Line("can I talk to a human", determinacy: .prose),
                "how long will that take", "refund please", "the tracking link doesn't work",
                "I need it before friday", "cancel the order instead", "can you resend the confirmation email",
    ...
    static func chat(
        ...
        Scenario(
            ...
            situation: GenerationSituation(
                ...
                isMultiline: true),
            cuts: .prose, determinacy: .any, band: CompletionExpectation.band(fitting: own + lines.map(\.text)),
