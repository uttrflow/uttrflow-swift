...
extension FixtureCatalogue {
    ...
    static let code: [Scenario] = [
        Scenario(
            ...
            known: [
                "func multiply(a: Int, b: Int) -> Int {", "let sum = add(a: 1, b: 2)",
            ...
            lines: [
                ...
                Line("struct Point: Equatable {", determinacy: .any),
                Line("import Foundation", determinacy: .any),
        ...
        Scenario(
            ...
            lines: [
                ...
                Line("for item in items:", determinacy: .any),
                Line("if __name__ == '__main__':", determinacy: .any),
        ...
        Scenario(
            ...
            lines: [
                ...
                Line("const total = add(2, 3);", determinacy: .any),
                Line("import { z } from 'zod';", determinacy: .any),
                Line("interface Point { x: number; y: number }", determinacy: .any),
