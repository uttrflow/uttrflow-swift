...
extension FixtureCatalogue {
    ...
    static let mail: [Scenario] = [
        mail(
            ...
            lines: [
                ...
                Line("Apologies for the delay.", determinacy: .prose), Line("Best regards,", determinacy: .prose),
                Line("Kind regards,", determinacy: .prose), "I hope this helps.", "Attached is the August invoice.",
                "Happy to walk you through it on a call.", Line("Looking forward to hearing from you.", determinacy: .prose),
        ...
        mail(
            ...
            own: ["Thursday morning works for me.", "Thanks for arranging this.", "Best,", "Could you confirm the time?"],
            lines: [
                "Thursday morning works for me.", Line("Thanks for arranging this so quickly.", determinacy: .prose),
                Line("Could you confirm the time, please?", determinacy: .prose), "I will be home from 9.",
                "Friday afternoon is better for me.", Line("Please let me know if that changes.", determinacy: .prose),
    ...
    static func mail(_ name: String, subject: String, thread: String, own: [String], lines: [Line]) -> Scenario {
        Scenario(
