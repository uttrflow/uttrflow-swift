...
extension FixtureCatalogue {
    ...
    static let notes: [Scenario] = [
        Scenario(
            ...
            forbidden: ["release goes out on Thursday", "measured latency on the larger", "shows last month's build"],
            lines: [
                "The next release adds tab-to-complete in every text field.",
                "We should measure the smaller model before shipping it.",
                "Latency on the smaller model is still unmeasured.", "Nobody reads the second paragraph, so keep it short.",
                ...
                "The beta group found two bugs in the address bar.", "Next week we start on speculative decoding.",
            ]),
        Scenario(
            ...
            lines: [
                ...
                "Support tickets fell by a third after the update.", "We plan to hire two engineers in the autumn.",
                "The main risk remains the cost of the larger model.",
                "Customers in India now make up half of new sign-ups.",
                "Revenue grew modestly while churn stayed flat.", "Our next milestone is the public beta in October.",
                "This report was prepared for the board meeting.", "Feedback from the pilot was mostly positive.",
            ]),
        Scenario(
            ...
            lines: [
                "butter", "coffee", "bananas", "tomatoes", "onions", "yoghurt", "toothpaste", "dish soap", "chicken",
                "spinach", "olive oil", "paneer",
            ]),
        Scenario(
            category: "notes", name: "todo",
            situation: GenerationSituation(
                application: "Notes", field: "Note Body Text View", preceding: "- call the bank\n- renew passport",
                windowTitle: "This week", recentLines: ["- renew passport", "- call the bank", "- book flights"],
                isMultiline: true),
