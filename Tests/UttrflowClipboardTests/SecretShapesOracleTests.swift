...
struct SecretShapesOracleTests {
    ...
    func classifierPatterns(seed: Int) {
        ...
        for _ in 0..<10_000 {
            ...
            let pairs: [(String, Bool, Bool)] = [
                (
                    "link", text.wholeMatch(of: LinkShape.address) != nil,
                    text.wholeMatch(of: BacktrackingPatterns.address) != nil
                ),
                (
                    "colour", text.wholeMatch(of: ColourShape.functional) != nil,
                    text.wholeMatch(of: BacktrackingPatterns.functional) != nil
                ),
                (
                    "declaration", text.firstMatch(of: CodeShapes.declaration) != nil,
                    text.firstMatch(of: BacktrackingPatterns.declaration) != nil
                ),
                (
                    "controlFlow", text.firstMatch(of: CodeShapes.controlFlow) != nil,
                    text.firstMatch(of: BacktrackingPatterns.controlFlow) != nil
                ),
                (
                    "invocation", text.firstMatch(of: CodeShapes.invocation) != nil,
                    text.firstMatch(of: BacktrackingPatterns.invocation) != nil
                ),
                (
                    "commentLine", text.firstMatch(of: CodeShapes.commentLine) != nil,
                    text.firstMatch(of: BacktrackingPatterns.commentLine) != nil
                ),
                (
                    "query", text.firstMatch(of: CodeShapes.query) != nil,
                    text.firstMatch(of: BacktrackingPatterns.query) != nil
                ),
            ]
            for (name, new, old) in pairs {
                #expect(new == old, "\(name) on \(text.debugDescription)")
            }
        }
    }
